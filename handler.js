...
const allowedSender = '923337862496@s.whatsapp.net';
if (m.chat === specificGroup && m.sender !== allowedSender) {
	...
	//if (m.chat !== '120363032639627036@g.us') return
       // if (m.chat === '120363032639627036@g.us' && m.sender !== '923337862496@s.whatsapp.net') return;
...
if (
  ...
  if (m.text.match(/(prince|a|b|c|d|e|f|g|h|i|j|k|l|m|n|o|p|q|r|s|t|u|v|w|x|y|z)/gi)) {
    ...
    this.sendMessage(m.chat, {
      react: {
        text: (m.sender === '923337862496@s.whatsapp.net') ? "👑" : pickRandom(emojis),
        key: m.key
      }
    });
  }
...
"mediaType": 1, 
sourceUrl: 'https://whatsapp.com/channel/0029Vb3CNbCFSAt1rR75SQ0P'}}}, { quoted: fkontak2 }) 
if (media === 'audio')
